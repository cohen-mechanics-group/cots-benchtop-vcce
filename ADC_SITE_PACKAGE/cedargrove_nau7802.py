...
_TS_ = 0x11 # POTENTIAL TEST FOR TEMP
...
class LDOVoltage:
    ...
    LDO_4V5 = 0x0  # LDO 3.3 volts; _CTRL1[5:3] = 4
    LDO_4V2 = 0x1  # LDO 3.3 volts; _CTRL1[5:3] = 4    
    LDO_3V9 = 0x2  # LDO 3.3 volts; _CTRL1[5:3] = 4
    LDO_3V6 = 0x3  # LDO 3.3 volts; _CTRL1[5:3] = 4
    LDO_3V3 = 0x4  # LDO 3.3 volts; _CTRL1[5:3] = 4
...
class NAU7802:
    ...
    def __init__(self, i2c_bus, address=0x2A, active_channels=1):
        ...
        #self._pu_ldo_source = False  # External analog power (AVDD)
        self.gain = 128  # X128
        self._c2_conv_rate = ConversionRate.RATE_80SPS  # 80SPS default
    ...
    # Custom Incorporation from BMU for register 0x11, i.e. temp-control
    _ts = RWBits(8, _TS_, 0x00)  # 8 bits, register 0x11, default value 0x00
    ...
    def read(self):
        ...
        self._adc_out = value / 128  # Restore to 24-bit signed integer value -- investigate
